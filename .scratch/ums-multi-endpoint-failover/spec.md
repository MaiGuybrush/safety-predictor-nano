...
# Spec: UMS API 多端點備援設定與無感容錯切換 (Failover)

**關聯 PRD**：[docs/prd/ums_multi_endpoint_failover_prd.md](file:///D:/Projects/argus/safty-predictor-nano/docs/prd/ums_multi_endpoint_failover_prd.md)  
